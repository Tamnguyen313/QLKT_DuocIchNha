...
namespace AdminKho.Areas.Admin.Controllers
{
    public class LothuocsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Malothuoc,Mathuoc,Tenlothuoc,Ngaynhap,Ngayxuat,Ngayhethan")] Lothuoc lothuoc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Malothuoc,Mathuoc,Tenlothuoc,Ngaynhap,Ngayxuat,Ngayhethan")] Lothuoc lothuoc)
        {
            if (ModelState.IsValid)
            {
