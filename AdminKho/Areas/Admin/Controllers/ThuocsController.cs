...
namespace AdminKho.Areas.Admin.Controllers
{
    public class ThuocsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Mathuoc,Tenthuoc,Manhacungcap,Manhomthuoc,Nhacungcap,Malothuoc,Donvitinh,Soluongtoithieu,Soluongtoida,Giatien,Ghichu")] Thuoc thuoc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Mathuoc,Tenthuoc,Manhacungcap,Manhomthuoc,Nhacungcap,Malothuoc,Donvitinh,Soluongtoithieu,Soluongtoida,Giatien,Ghichu")] Thuoc thuoc)
        {
            if (ModelState.IsValid)
            {
