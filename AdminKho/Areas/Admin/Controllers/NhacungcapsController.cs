...
namespace AdminKho.Areas.Admin.Controllers
{
    public class NhacungcapsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Manhacungcap,Tennhacungcap,Email,Sodienthoai,Diachi,Ghichu")] Nhacungcap nhacungcap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Manhacungcap,Tennhacungcap,Email,Sodienthoai,Diachi,Ghichu")] Nhacungcap nhacungcap)
        {
            if (ModelState.IsValid)
            {
