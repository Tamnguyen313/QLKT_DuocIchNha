...
namespace QLKT_DuocIchNhan.Areas.Admin.Controllers
{
    public class NhomthuocsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Manhomthuoc,Tennhomthuoc,Malothuoc,Ghichu")] Nhomthuoc nhomthuoc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Manhomthuoc,Tennhomthuoc,Malothuoc,Ghichu")] Nhomthuoc nhomthuoc)
        {
            if (ModelState.IsValid)
            {
